            ...
            components={{
                ...
                code: ({ ...props }) => (
                    <code
                        ...
                        className="bg-[#171717] px-1.5 py-0.5 rounded text-[13px] sm:text-[13.5px] md:text-[14px] font-mono text-blue-200 "
                        {...props}
                    />
                ),
                pre: ({ ...props }) => (
                    <pre
                        style={{
                            // Force the pre element to respect its container
                            maxWidth: '100%',
                            // Ensure code doesn't break out of container
                            whiteSpace: 'pre-wrap',
                            wordWrap: 'break-word'
                        }}
                        className="bg-[#171717] p-3 md:p-4 rounded-lg overflow-x-auto text-[13px] md:text-[14px] my-2 md:my-3 "
                        {...props}
                    />
                ),
